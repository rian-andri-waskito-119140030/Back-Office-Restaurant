                ...
                <div class="row">
                    <div class="col-md-4 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('laporanmasuk.update', $laporanmasuk->id_laporan_masuk) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group mx-auto">
                                        <div class="mb-3">
                                            <label for="">Hari</label>
                                            <input type="text" class="form-control" name="hari" value="{{ $laporanmasuk->hari }}">
                                        </div>
                                        <!-- <div class="mb-3">
                                            <label>Tanggal</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pemasukan" value="{{ $laporanmasuk->pemasukan }}">
                                        </div>
